//app\(private-route)\edit-profile\page.tsx
...
const EditProfile: FC<Props> = () => {
  ...
  if (status === "loading") return <div className="flex items-center justify-center min-h-screen">
  ...
  return (
    <div className="space-y-6 max-w-96 mx-auto pt-20 sm:p-0 p-4">
      <form action={updateProfileInfo} className="space-y-4">
        <Input name="name" placeholder="" label="Name" />
