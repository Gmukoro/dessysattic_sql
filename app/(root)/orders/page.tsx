...
const Orders = async () => {
  ...
  return (
    <div className="px-10 py-5 max-sm:px-3">
      <p className="text-heading2-bold text-4xl font-bold mb-8 relative bg-gradient-to-r from-yellow-400 via-yellow-900 to-amber-500 text-white py-4 px-8 rounded-lg shadow-lg  after:left-1/2 after:transform after:-translate-x-1/2">
        Your Orders
      </p>
